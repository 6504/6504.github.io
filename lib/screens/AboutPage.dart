              ...
              children: <Widget>[
                ...
                Padding(
                    padding: EdgeInsets.all(20.0).copyWith(
                        left:
                            MediaQuery.of(context).size.width >= 850 ? 100 : 10,
                        right: MediaQuery.of(context).size.width >= 850
                            ? 100
                            : 10),
                    child: Column(
                      children: <Widget>[
                        Wrap(
                          ...
                          children: <Widget>[
                            Text(
                              "2019",
                              style: getTextStyle().copyWith(
                                  fontFamily: 'ConcertOne', fontSize: 30.0),
                            ),
                            AboutCard(
                            ...
                            AboutCard(
                                ...
                                "During our second year competing in FRC, we suprised ourselves by placing as finalists at Battlefield High School and making it to the District Championship at the Xfinity Center.",
                                "March 2018"),
                            Text(
                              "2017",
                              style: getTextStyle().copyWith(
