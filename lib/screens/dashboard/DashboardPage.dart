...
class DashboardPageState extends State<DashboardPage> {
  ...
  void initState() {
    super.initState();
    firestore().collection("users").doc(widget._user.uid).get().then(
        (documentSnapshot) =>
            {widget._userData = documentSnapshot.data(), setState(() {})});
  }
              ...
              children: <Widget>[
                ListView(
                  children: <Widget>[
                    ...
                    GridView.count(
                      crossAxisCount:
                          MediaQuery.of(context).size.width >= 850 ? 5 : 1,
                      childAspectRatio:
                          MediaQuery.of(context).size.width >= 850 ? 2.5 : 2.5,
                                ...
                                children: <Widget>[
                                  Row(
                                    children: <Widget>[
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                              image: AssetImage(
                                                  'images/members/${widget._userData["avatar"] == null ? "nopic.png" : widget._userData["avatar"]}'),
                                              fit: BoxFit.fill),
                                        ),
                                      ),
                                      Padding(
                                      ...
                                      AutoSizeText(
                                        "Welcome, ${widget._userData["nickname"] == null ? "null" : widget._userData["nickname"]}!",
                                        style: getTextStyle(),
                                        minFontSize: 12,
                                        maxFontSize: 30.0,
                                      ),
